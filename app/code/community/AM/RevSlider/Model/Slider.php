...
class AM_RevSlider_Model_Slider extends Mage_Core_Model_Abstract{
    ...
    const TRANSITION_0      = 'random-selected';
    ...
    public function getTransistionOptions(){
        return array(
            array(
                ...
                'value' => array(
                    array('value' => self::TRANSITION_0, 'label' => Mage::helper('revslider')->__('Random of Selected')),
    ...
    public function checkAlias($alias){
        return $alias ? $this->_getResource()->checkAlias($alias) : false;
    }

    public function loadByAlias($alias){
        $id = $this->checkAlias($alias);
        if ($id) $this->load($id);
        return $this;
    }

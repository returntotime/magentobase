...
class AM_RevSlider_Block_Adminhtml_Slider_Edit_Tab_Main
    ...
    public function _prepareForm(){
        ...
        $fieldset->addField('title', 'text', array(
            ...
            'required'  => true,
            'note'      => Mage::helper('revslider')->__('The title of the slider. Example: Slider #1')
        ));
        $fieldset->addField('alias', 'text', array(
            'name'      => 'alias',
            'label'     => Mage::helper('revslider')->__('Alias'),
            'title'     => Mage::helper('revslider')->__('Alias'),
            'required'  => true,
            'note'      => Mage::helper('revslider')->__('The alias of the slider. Example: slider-1')
        ));
        ...
        $layout43 = $fieldset->addField('fullscreen_offset_size', 'text', array(
            'name'      => 'fullscreen_offset_size',
            'label'     => Mage::helper('revslider')->__('Offset Containers'),
            'title'     => Mage::helper('revslider')->__('Offset Containers'),
            'note'      => Mage::helper('revslider')->__('Defines an Offset to the top. Can be used with px and %. Example: 40px or 10%')
        ));
        ...
        $fieldset->addField('min_height', 'text', array(
            'name'      => 'min_height',
            'label'     => Mage::helper('revslider')->__('Min. Height'),
            'title'     => Mage::helper('revslider')->__('Min. Height'),
            'class'     => 'validate-number'
        ));
        ...
        $this->setChild('form_after', $dependenceElement
            ...
            ->addFieldMap($layout43->getHtmlId(), $layout43->getName())
            ...
            ->addFieldDependence($layout43->getName(), $layout->getName(), 'fullscreen')

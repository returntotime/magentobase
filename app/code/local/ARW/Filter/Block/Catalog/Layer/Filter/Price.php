<?php
class ARW_Filter_Block_Catalog_Layer_Filter_Price extends Mage_Catalog_Block_Layer_Filter_Price{
    protected $_hash;
    protected $_maxPrice;
    ...
    public function __construct(){
        parent::__construct();
        if (Mage::helper('arwfilter')->isPriceEnable()){
            $this->setTemplate('arw/filter/price.phtml');
            $this->_hash = Mage::helper('core')->uniqHash('slider-');
            $this->_filterModelName = 'arwfilter/layer_filter_price';
        }
    }

...
$installer->addAttribute('catalog_category', 'arwmenu_cat_block_right', array(
    'group'				=> 'Main Menu',
    'label'				=> 'Block Right',
...
$installer->addAttribute('catalog_category', 'arwmenu_proportions_right', array(
    'group'				=> 'Main Menu',
...
$installer->addAttribute('catalog_category', 'arwmenu_cat_block_left', array(
    'group'				=> 'Main Menu',
    'label'				=> 'Block Left',
    'note'				=> "This field is applicable only for top-level categories.",
    'type'				=> 'text',
...
$installer->addAttribute('catalog_category', 'arwmenu_proportions_left', array(
    'group'				=> 'Main Menu',
...
$installer->addAttribute('catalog_category', 'arwmenu_cat_columns', array(
    'group'				=> 'Main Menu',
...
$installer->addAttribute('catalog_category', 'arwmenu_cat_groups', array(
    'group'				=> 'Main Menu',
...
$installer->addAttribute('catalog_category', 'arwmenu_cat_block_top', array(
    'group'				=> 'Main Menu',
    'label'				=> 'Block Top',
    'type'				=> 'text',
    'input'				=> 'textarea',
...
$installer->addAttribute('catalog_category', 'arwmenu_cat_block_bottom', array(
    'group'				=> 'Main Menu',
    'label'				=> 'Block Bottom',
    'type'				=> 'text',
    'input'				=> 'textarea',
...
$installer->addAttribute('catalog_category', 'arwmenu_cat_label', array(
    'group'				=> 'Main Menu',

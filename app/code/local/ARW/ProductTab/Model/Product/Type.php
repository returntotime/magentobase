<?php
class ARW_ProductTab_Model_Product_Type 
{
    const NONE = 0;
    ...
    const BESTSELL = 2;
    const BESTSELL_LABEL = 'Best Sellers';
    const TOPRATED = 3;
    ...
    public function toOptionArray()
    {
        ...
        return array(
            array('value' => self::NONE, 'label' => $helper->__(self::NONE_LABEL)),
            ...
            array('value' => self::CURRENTCATEGORY, 'label' => $helper->__(self::CURRENTCATEGORY_LABEL))
        );
    }
}

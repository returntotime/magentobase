...
class ARW_Brand_IndexController extends Mage_Core_Controller_Front_Action
{
    ...
    public function viewAction()
    {
        ...
        if (Mage::helper('brand')->layeredNavigationView() != '' || Mage::helper('brand')->layeredNavigationView() != 'no') {
            if (Mage::helper('brand')->layeredNavigationView() == 'top-left') {
                $leftBlock = $this->getLayout()->createBlock('brand/layer_view', 'brand.nav')->setTemplate('arw/brand/layer/view.phtml');
                ...
                $rightBlock = $this->getLayout()->createBlock('brand/layer_view', 'brand.nav')->setTemplate('arw/brand/layer/view.phtml');
                $stateRenderersBlock = $this->getLayout()->createBlock('core/text_list', 'brand.nav.state.renderers');
                ...
                $block = $this->getLayout()->createBlock('brand/layer_view', 'brand.nav')->setTemplate('arw/brand/layer/view.phtml');
                $stateRenderersBlock = $this->getLayout()->createBlock('core/text_list', 'brand.nav.state.renderers');
